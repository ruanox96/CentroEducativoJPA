...
public class PanelProfesores extends JPanel {
	...
	public void initialize() {
		...
		btnAnterior.setIcon(new ImageIcon(PanelProfesores.class.getResource("/fotos/patras.png")));
		...
		btnUltimo.setIcon(new ImageIcon(PanelProfesores.class.getResource("/fotos/final.png")));
		...
		btnBorrar.setIcon(new ImageIcon(PanelProfesores.class.getResource("/fotos/borrar.jpg")));
